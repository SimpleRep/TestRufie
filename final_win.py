...
class FinalWin(QWidget):
   ...
   def initUI(self):
       ...
       self.btn_home = QPushButton("Повторить Эксперимент", self)
 
       self.layout_line = QVBoxLayout()
       self.layout_line.addWidget(self.index_text, alignment = Qt.AlignCenter)
       self.layout_line.addWidget(self.work_text, alignment = Qt.AlignCenter)
       #Добавить кнопку домой
       self.layout_line.addWidget(self.btn_home, alignment = Qt.AlignCenter)
       
       self.setLayout(self.layout_line)
       #Связь кнопки с функцией
       self.btn_home.clicked.connect(self.home_click)
